...
<div class="panel panel-default">
    ...
    Type
    <select class="form-control class_type2" data-value="<%= Request["type"] %>" id="type" name="type"><option value="">Please choose</option><option value="Single topic selection">Single topic selection</option><option value="Multiple choice">Multiple choice</option></select><script>
