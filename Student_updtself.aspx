...
<div class="panel panel-default">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <select class="form-control class_sex3" data-value="<%= Info.html(mmm["sex"]) %>" id="sex" name="sex" style="width:250px"><option value="male">male</option><option value="female">female</option></select><script>
