            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr align="center">
                        ...
                        <th width="280" data-field="handler">Operation</th>
                    </tr>
                    </thead>
                    <tbody>
                    <%
                    ...
                    %>
                        <tr id="<%= map["id"] %>" pid="">
                            ...
                            <td align="center">
                                ...
                                <a href="QuestionInfo_add.aspx?id=<%= map["id"] %>">Add question bank</a>
                                <a href="QuestionInfo_list.aspx?subjectid=<%= map["id"] %>">Query question bank</a>
