...
<div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="Result_updt.aspx?f=f" method="post" name="form1" id="form1">
    ...
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">Options detail</label>
        <div class="col-sm-8">
