...
<head>
    ...
    <title>Automated Online Multiple Choice Question System-Backstage management</title>
...
<header class="header">
    <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
        ...
        <a href="Main.aspx" class="font-weight-bold text-uppercase text-base">Automated Online Multiple Choice Question System</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          
            <li class="nav-item ml-2">
                <a href="action.ashx?a=logout" class="btn btn-danger" onclick="return confirm('Are you sure to exit？')">Retreat safely</a>
            </li>
            <li class="nav-item ml-2">
                Login please：<%= Session["username"] %>，<%= Session["cx"] %>
            </li>
